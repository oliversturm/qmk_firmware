...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LAYOUT_BASE_DVORAK] = LAYOUT(
        ...
        KC_LSHIFT, KC_SCLN, KC_Q,    KC_J,    KC_K,    KC_X,    KC_B,    KC_M,    KC_W,    KC_V,    KC_Z,    KC_RSHIFT,                              KC_UP, \
        KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,                             KC_RALT, MO(LAYOUT_STANDARD_FN),   /*TEST_OUTPUT_LAYER*/OSL(LAYOUT_SPECIAL_CHARS),  KC_RCTL,            KC_LEFT, KC_DOWN, KC_RGHT \
    ),
    ...
    [LAYOUT_SPECIAL_CHARS] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,            _______, _______, _______, \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   _______, _______, _______, \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, X(POUND) /*L*/, _______, _______, _______,   _______, _______, _______, \
        _______, XP(AE, AE_UPPER)/*A*/, XP(OE, OE_UPPER)/*O*/, _______, XP(UE, UE_UPPER)/*U*/, _______, _______, _______, _______, _______, X(SS)/*S*/, _______, _______, \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                              _______, \
        _______, _______, _______,                   _______,                            _______, _______, _______, _______,            _______, _______, _______ \
    ),
...
const uint8_t PROGMEM ledmap[][DRIVER_LED_TOTAL][3] = {
    ...
    [LAYOUT_SPECIAL_CHARS] = {
        ...
        // 17 keys
        _______,  _______,  _______,  _______, _______,  _______,  _______, _______, _______, _______, GREEN /*L*/, _______, _______, _______, _______,  _______,  _______,

        // 13 keys
        _______, GREEN /*A*/, GREEN /*O*/, _______, GREEN /*U*/, _______,  _______, _______, _______, _______, GREEN /*S*/, _______, _______,

        // 13 keys
        _______, _______,  _______, _______,   _______, _______, _______,   _______, _______, _______, _______, _______,                         _______,

        // 11 keys
        _______, _______, _______,                   _______,                            _______, _______,    RED, _______,            _______, _______, _______,
